...
namespace VL_Launcher
{
    public class Translation
    {
        public static Dictionary<string, string> japanese = new Dictionary<string, string>()
        {
            ...
            { "welcome", "ようこそ" },
            { "welcome-dl-head", "ダウンロード" },
            { "welcome-dl-txt", "ダウンロードの時、指定された Minecraft バージョンを選択してください。" },
            { "welcome-auth-head", "ログイン" },
            { "welcome-auth-txt", "このフォルダに nide8auth.jar があるかどうかをご確認してください。\nhttps://login2.nide8.com:233/index/jar でダウンロードできます。" },
            { "welcome-unix-head", "macOS と Linux の使っている方" },
            ...
            { "launcher-prep-dl", "ダウンロードが準備しています" },
        ...
        public static Dictionary<string, string> chinese = new Dictionary<string, string>()
        {
            ...
            { "welcome", "欢迎" },
            { "welcome-dl-head", "下载" },
            { "welcome-dl-txt", "在下载时，请选择服务器指定的 Minecraft 版本。" },
            { "welcome-auth-head", "登录" },
            { "welcome-auth-txt", "请确认当前目录下是否有 nide8auth.jar 。\n您可以在 https://login2.nide8.com:233/index/jar 处下载。" },
        ...
        public static Dictionary<string, string> english = new Dictionary<string, string>()
        {
            { "head", "Minecraft Vast-Light" },
            { "welcome", "Welcome" },
            { "welcome-dl-head", "Download" },
            { "welcome-dl-txt", "Before download, please select the specified Minecraft version required by the server" },
            { "welcome-auth-head", "Login" },
            { "welcome-auth-txt", "Please check if nide8auth.jar is in current directory.\nYou can also download it from https://login2.nide8.com:233/index/jar." },
            ...
            { "launcher-prep-dl", "Preparing for download" },
